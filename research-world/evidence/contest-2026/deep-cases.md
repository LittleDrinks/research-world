...
|---|---|---:|---:|---:|---|---|
| `q049` | 引文约束、限定计算、同模型直接回答 | 9/12 | 12/12 | 6/6 | `completed` | `q049/v4.md`、`q049/review-v4.md`、`q049/receipt-v4.md`、`q049/run.md` |
...
| `q112` | 功能单位、LCA、复用 break-even | 7/12 | 12/12 | 9/9 | `waiting_human` | `q112/v6.md`、`q112/review-v6.md`、`q112/run.md` |
| `q098` | 三机制比较、人体时序 pilot | 7/12 | 12/12 | 8/8 | `waiting_human` | `q098/v9.md`、`q098/review-v9.md`、`q098/run.md` |
## 同条件对照
...
|---|---:|---:|---:|---:|
| `q049` | 483 | 3803920 | 14198272 | 228568 |
| `q089` | 256 | 1498774 | 6476928 | 157845 |
| `q021` | 355 | 2256928 | 9117312 | 183101 |
| `q112` | 213 | 1406456 | 4913920 | 112766 |
| `q098` | 337 | 2552362 | 9577472 | 192584 |
| **合计** | **1644** | **11518440** | **44283904** | **874864** |
