...
|---|---|---:|---:|---:|---|---|
| `q049` | 引文约束、限定计算、同模型直接回答 | 9/12 | 12/12 | 6/6 | `completed` | `q049/v8.md`、`q049/review-v8.md`、`q049/receipt-v9.md`、`q049/run.md`；matched 展示链为 `baseline-matched-v9.md`、`review-baseline-matched-v10.md`、`receipt-baseline-matched-v9.md` |
| `q089` | 效率边界、材料路线、TPV 计划 | 10/12 | 12/12 | 8/8 | `completed` | `q089/v11.md`、`q089/review-v14.md`、`q089/receipt-v14.md`、`q089/run.md` |
| `q021` | 冲突证据、临床 pilot、ITT | 10/12 | 12/12 | 8/8 | `waiting_human` | `q021/v10.md`、`q021/review-v12.md`、`q021/receipt-v13.md`、`q021/run.md` |
| `q112` | 功能单位、LCA、复用 break-even | 7/12 | 12/12 | 9/9 | `waiting_human` | `q112/v11.md`、`q112/review-v13.md`、`q112/receipt-v12.md`、`q112/run.md` |
| `q098` | 三机制比较、人体时序 pilot | 7/12 | 12/12 | 8/8 | `waiting_human` | `q098/v12.md`、`q098/review-v13.md`、`q098/receipt-v15.md`、`q098/run.md` |
## 同条件对照
...
|---|---:|---:|---:|---:|
| `q049` | 743 | 5355455 | 25192355 | 506644 |
| `q089` | 441 | 2335565 | 12255774 | 303378 |
| `q021` | 486 | 2847498 | 14484554 | 306444 |
| `q112` | 448 | 2548843 | 13831963 | 314428 |
| `q098` | 483 | 3178819 | 14229219 | 317870 |
| **合计** | **2601** | **16266180** | **79993865** | **1748764** |
统计包含基线、生成、评审、修订和失败 Session；168 个 Session UUIDv7 唯一，162 个文件 SHA-256 均与当前内容一致，明细见对应 `run.md`。
## 放大前结论
