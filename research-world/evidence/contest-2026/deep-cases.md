...
|---|---|---:|---:|---:|---|---|
| `q049` | 引文约束、限定计算、同模型直接回答 | 9/12 | 12/12 | 6/6 | `completed` | `q049/v5.md`、`q049/review-v5.md`、`q049/receipt-v6.md`、`q049/run.md`；matched 展示链为 `baseline-matched-v9.md`、`review-baseline-matched-v10.md`、`receipt-baseline-matched-v9.md` |
...
| `q112` | 功能单位、LCA、复用 break-even | 7/12 | 12/12 | 9/9 | `waiting_human` | `q112/v6.md`、`q112/review-v8.md`、`q112/receipt-v8.md`、`q112/run.md` |
...
|---|---:|---:|---:|---:|
| `q049` | 630 | 4740040 | 21082752 | 390808 |
| `q089` | 280 | 1612961 | 6948096 | 169321 |
| `q021` | 378 | 2397392 | 9661952 | 199319 |
| `q112` | 266 | 1749337 | 6901248 | 157719 |
| `q098` | 410 | 2869860 | 11614336 | 243646 |
| **合计** | **1964** | **13369590** | **56208384** | **1160813** |
统计包含基线、生成、评审、修订和失败 Session；118 个 Session UUIDv7 唯一，112 个文件 SHA-256 均与当前内容一致，明细见对应 `run.md`。
## 放大前结论
