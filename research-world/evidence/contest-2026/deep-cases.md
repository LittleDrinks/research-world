...
|---|---|---:|---:|---:|---|---|
| `q049` | 引文约束、限定计算、同模型直接回答 | 9/12 | 12/12 | 5/5 | `completed` | `q049/v4.md`、`q049/review-v4.md`、`q049/run.md` |
| `q089` | 效率边界、材料路线、TPV 计划 | 10/12 | 12/12 | 8/8 | `completed` | `q089/v7.md`、`q089/review-v7.md`、`q089/run.md` |
| `q021` | 冲突证据、临床 pilot、ITT | 10/12 | 12/12 | 8/8 | `waiting_human` | `q021/v8.md`、`q021/review-v8.md`、`q021/run.md` |
| `q112` | 功能单位、LCA、复用 break-even | 7/12 | 12/12 | 9/9 | `waiting_human` | `q112/v5.md`、`q112/review-v5.md`、`q112/run.md` |
| `q098` | 三机制比较、人体时序 pilot | 7/12 | 12/12 | 8/8 | `waiting_human` | `q098/v7.md`、`q098/review-v7.md`、`q098/run.md` |
## 同条件对照
...
|---|---:|---:|---:|---:|
| `q049` | 470 | 3706234 | 13839232 | 219391 |
| `q089` | 237 | 1364625 | 5860224 | 150408 |
| `q021` | 355 | 2256928 | 9117312 | 183101 |
| `q112` | 187 | 1235290 | 4360704 | 97084 |
| `q098` | 274 | 2120622 | 7106432 | 152186 |
| **合计** | **1523** | **10683699** | **40283904** | **802170** |
