...
|---|---|---:|---:|---:|---|---|
| `q049` | 引文约束、限定计算、同模型直接回答 | 9/12 | 12/12 | 6/6 | `completed` | `q049/v7.md`、`q049/review-v7.md`、`q049/receipt-v8.md`、`q049/run.md`；matched 展示链为 `baseline-matched-v9.md`、`review-baseline-matched-v10.md`、`receipt-baseline-matched-v9.md` |
| `q089` | 效率边界、材料路线、TPV 计划 | 10/12 | 12/12 | 8/8 | `completed` | `q089/v8.md`、`q089/review-v11.md`、`q089/receipt-v12.md`、`q089/run.md` |
| `q021` | 冲突证据、临床 pilot、ITT | 10/12 | 12/12 | 8/8 | `waiting_human` | `q021/v9.md`、`q021/review-v11.md`、`q021/receipt-v12.md`、`q021/run.md` |
| `q112` | 功能单位、LCA、复用 break-even | 7/12 | 12/12 | 9/9 | `waiting_human` | `q112/v8.md`、`q112/review-v10.md`、`q112/receipt-v10.md`、`q112/run.md` |
| `q098` | 三机制比较、人体时序 pilot | 7/12 | 12/12 | 8/8 | `waiting_human` | `q098/v11.md`、`q098/review-v12.md`、`q098/receipt-v14.md`、`q098/run.md` |
## 同条件对照
...
|---|---:|---:|---:|---:|
| `q049` | 704 | 5142294 | 23396771 | 456188 |
| `q089` | 336 | 1834653 | 8685027 | 216915 |
| `q021` | 443 | 2635189 | 12201930 | 250879 |
| `q112` | 362 | 2068615 | 11095451 | 219682 |
| `q098` | 449 | 3025513 | 12951395 | 274579 |
| **合计** | **2294** | **14706264** | **68330574** | **1418243** |
统计包含基线、生成、评审、修订和失败 Session；143 个 Session UUIDv7 唯一，137 个文件 SHA-256 均与当前内容一致，明细见对应 `run.md`。
## 放大前结论
