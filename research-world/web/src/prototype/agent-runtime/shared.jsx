...
const ICONS = { ready: Check, configured: Check, "not-required": Check, succeeded: Check, found: CircleDot, running: LoaderCircle, "auth-required": CircleAlert, missing: CircleDashed, invalid: CircleAlert, error: CircleAlert, failed: CircleAlert, cancelled: CircleDashed, unsupported: CircleDashed, blocked: CircleAlert, unknown: CircleDot, "setup-required": Clock3, unavailable: CircleDashed };
