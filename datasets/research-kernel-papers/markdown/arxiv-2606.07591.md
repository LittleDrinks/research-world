## arXiv:2606.07591v5 [cs.LG] 3 Jul 2026
...
5 um pump -&gt; graphene replica bands Polarization test -&gt; Volkov evidence
...
and evaluability, ResearchClawBench introduces Reference-Anchored Discovery Score (RADS). RADS treats each target paper as a human reference study under the same scientific objective, rather than

- as a closed-form ground truth. The agent is evaluated by whether its evidence, quantitative results, mechanistic analysis, and experimental reasoning are weaker than, comparable to, or stronger than this reference study.
...
2026], EvoScientist [Lyu et al., 2026], and ResearchClaw [Yang, 2026]. We also evaluate seventeen native LLM baselines through ResearchHarness: Claude-Opus-4.6 [Anthropic, 2026b], Claude-Opus-4.7, DeepSeek-V4-Pro [DeepSeek-AI, 2026], GLM-5.1 [Z.AI, 2026], GPT-5.4 [OpenAI, 2026b], GPT5.5, Gemini-3.1-Pro [Google, 2026a], Gemini-3.5-Flash [Google, 2026b], Grok-4.1 [xAI, 2025], Grok-4.3 [xAI, 2026], Kimi-K2.5 [Team et al., 2026], Kimi-K2.6 [Moonshot AI, 2026], MiMo-V2Pro [Xiaomi, 2026], MiMo-V2.5 [XiaomiMiMo, 2026], Qwen3.5-397B-A17B [Qwen Team, 2026a],
...
15-day FuXi ACC/RMSE vs ECMWF/GraphCast.

Got:

6-hour persistence and linearextrapolation audit.

Wrong:

Protocol, horizon, and baselines changed.

Astronomy_002 Expected:

GLS Distance Network: H0=73.48 plus residuals.

Got:

H0 near 109; no hostresidual plot.

Wrong:

Numbers and evidence contradict the target.

Chemistry_000 Expected:

KA-GNN message passing and saliency analysis.

Got:

RDKit descriptors plus a Fourier-KAN head.

Wrong:

The central model mechanism is absent.

|Information_000 Expected:<br><br>OCR, Janus generation, and meme reasoning<br><br>Got:<br><br>Generic multimodal architecture diagnosis.<br><br>Wrong:<br><br>Solved a neighboring meta-analysis task.|
|---|


Material_000 Expected:

Metrics from verifiable crystal-GNN training.

Got:

Fallback rankings claimed as AUROC/AP/top-50 hits.

Wrong:

Evidence is not traceable to executed training.

|Energy_001 Expected:<br><br>Feasible OPF dispatch, curtailment, link loading.<br><br>Got:<br><br>Log: Problem status: Infeasible; no numeric data.<br><br>Wrong:<br><br>No usable dispatch artifacts were produced.|
|---|
...
Claude Code 44.6 58.0 49.0 76.4 Codex CLI 48.6 65.9 50.8 74.4 ARIS Codex 44.2 60.9 43.7 71.8 OpenClaw 45.5 56.4 47.2 75.0 Nanobot 39.3 50.1 43.9 71.6 EvoScientist v0.0.4 47.1 59.5 45.6 73.5 ResearchClaw 47.4 62.2 52.7 74.8
...
- (a) Autonomous agents Task C.Code Codex ARIS Open Nano Evo0 Evo1 RClaw
...
- Table 8 continued. Panel (a) Autonomous agents. Task C.Code Codex ARIS Open Nano Evo0 Evo1 RClaw
